...
srcUrl = 'https://piratetv.ml/tvp1hd.html';
iframe1.src = srcUrl;
iframe1.id = 'rk';
...
const ChangeFile2 = () => {
    srcUrl = 'https://piratetv.ml/tvp2hd.html';
    iframe1.src = srcUrl;
}
file2.addEventListener('click', ChangeFile2);
const ChangeFile3 = () => {
    srcUrl = 'https://piratetv.ml/puls1.html';
    iframe1.src = srcUrl;
}
file3.addEventListener('click', ChangeFile3);
}
file2.addEventListener('click', ChangeFile4);
const ChangeFile3 = () => {
    srcUrl = 'https://piratetv.ml/polsat2.html';
    iframe1.src = srcUrl;
}
file3.addEventListener('click', ChangeFile5);
